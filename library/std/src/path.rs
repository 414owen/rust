...
impl PathBuf {
    ...
    #[must_use]
    #[inline]
    #[rustc_const_stable(feature = "const_pathbuf_osstring_new", since = "1.92.0")]
    ...
    /// assert_eq!(Path::new("/feel/the.formatted.dark"), p.as_path());
    /// ```
    #[stable(feature = "path_add_extension", since = "1.92.0")]
...
#[stable(feature = "eq_str_for_path", since = "1.92.0")]
...
impl Path {
    ...
    ///
    #[stable(feature = "path_file_prefix", since = "1.92.0")]
    #[must_use]
