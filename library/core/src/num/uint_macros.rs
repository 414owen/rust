macro_rules! uint_impl {
    (
        ...
        /// ```
        #[stable(feature = "strict_overflow_ops", since = "1.92.0")]
        #[rustc_const_stable(feature = "strict_overflow_ops", since = "1.92.0")]
        #[must_use = "this returns the result of the operation, \
                      without modifying the original"]
        #[inline]
        #[track_caller]
        ...
        /// ```
        #[stable(feature = "unsigned_signed_diff", since = "1.92.0")]
        #[rustc_const_stable(feature = "unsigned_signed_diff", since = "1.92.0")]
        #[inline]
        ...
        /// ```
        #[stable(feature = "unsigned_bigint_helpers", since = "1.92.0")]
