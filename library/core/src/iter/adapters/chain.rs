use crate::iter::{
    Exact, Finite, FusedIterator, Infinite, QuantifiedIterator, TrustedLen, quantify_fn_2,
};
...
/// ```
#[stable(feature = "iter_chain", since = "1.92.0")]
...
{
    type Quantity = <(A::Quantity, B::Quantity) as ChainQuantity>::Result;
}
